...
<div class="bg-gray-200 dark:bg-gray-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    ...
    <div>
        ...
        <p class="mt-4 text-sm">
            <a href="/consultar-exame" class="inline-flex items-center font-semibold text-indigo-700 dark:text-indigo-300">
                Consultar Exame
    ...
    <div>
        ...
        <p class="mt-4 text-sm">
            <a href="/novo-exame" class="inline-flex items-center font-semibold text-indigo-700 dark:text-indigo-300">
                Iniciar Novo Exame
